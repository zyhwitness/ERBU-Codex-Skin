...
1. 从 Microsoft Store 安装官方 `OpenAI.Codex`
2. 安装 Node.js 22 或更高版本
3. 在 PowerShell 进入仓库的 `windows/` 目录
4. 执行 `powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\install-dream-skin.ps1`
